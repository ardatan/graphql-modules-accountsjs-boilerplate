...
> {
  ...
  public onChangePictureUrl = ({ target }: React.ChangeEvent<HTMLInputElement>) => {
  ...
  public render() {
    ...
    const { username, password, pictureUrl, error } = this.state;
    return (
      <form onSubmit={this.onSubmit} className={classes.formContainer}>
        ...
        <FormControl margin="normal">
          <InputLabel htmlFor="email">Picture URL</InputLabel>
          <Input id="pictureUrl" value={pictureUrl} onChange={this.onChangePictureUrl} />
        </FormControl>
        <FormControl margin="normal">
